...
(function (global) {
    ...
    document.addEventListener("DOMContentLoaded", function (event) {
        ...
        $ajaxUtils.sendGetRequest(
            allCategoriesUrl,
            buildAndShowHomeHTML, // STEP 1: Call buildAndShowHomeHTML when server responds with the categories data
    ...
    function chooseRandomCategory(categories) {
        ...
        return categories[randomArrayIndex]; // return category object with that randomArrayIndex
    }
